      ...
      <div class="flex-1 pl-2 md:pl-8 xl:pl-16 pr-2 md:pr-8 xl:pr-16 pb-16">
        <div class="pt-8">
          ...
          <div class="text-gray-800 text-base md:text-lg leading-8 [&>p]:mb-4">
            ...
            <p>
              はじめまして！ ＪＩＭＭＹです。どうぞよろしく～。<br>
              <strong>「JIMMY's Homepage」</strong>は、私、JIMMYの個人サイトです。<br>
              過去に投稿した文章などを沢山載せていますので、ぜひご覧下さい。
            </p>
            <p>
            ...
            <p>
              「JIMMY」は、94年に初めて「歌劇」誌「高声低声」に投稿した時から使っている私のペンネームです。
            </p>
            <p>
              JIMMYが管理する宝塚好きな方の為の会員制掲示板、「WAIWAI
              TAKARAZUKA」もおかげさまで盛況です。最新の話題はここに書き込んでおります。ぜひご覧ください。
            </p>
          </div>
        </div>
      </div>
