      ...
      <div class="flex-1 pl-2 md:pl-8 xl:pl-16 pr-2 md:pr-8 xl:pr-16 pb-16">
        <div class="pt-8">
          ...
          <div class="text-gray-800 text-base md:text-lg leading-8 [&>p]:mb-4">
            ...
            <p><strong>となみちゃん(白羽ゆり)</strong>を初めて舞台で認識したのは<strong>「BLUE MOON BLUE」のウサギちゃん</strong>の一人に抜擢されていた時。キレイだと評判にはなっていましたが、<strong>「そうかな～？」</strong>と思った程度。公演の後半頃になってやっと、化粧がキレイになって、<strong>なるほどキレイな人なのかな</strong>、と思いました。</p>
