      ...
      <div class="flex-1 pl-2 md:pl-8 xl:pl-16 pr-2 md:pr-8 xl:pr-16 pb-16">
        <div class="pt-8">
          ...
          <div class="text-gray-800 text-base md:text-lg leading-8 [&>p]:mb-4">
            ...
            <p>
              <strong>きぶなおちゃん(貴船尚)</strong>、いきま～す！<br>
              今月の生徒評は、最新の雪組公演<strong>「霧のミラノ／ワンダーランド」</strong>を観て決めよう！　という事で、まず選ばせて頂いたのがきぶなおちゃん。<br>
              ちょっと痩せたのかな？　スッキリして男らしくなったのも良いですし、芝居も親しみやすいキャラクターに磨きがかかって、とても気持ちよく、目立っていました。
            </p>

            <p>
              きぶなおちゃんの初認識は・・おそらく<strong>「エンカレッジ・コンサート」</strong>。<br>
              「アランチャ」「スター・ダスト」という選曲が、かりんちょさん(杜けあき)好きなのかな?　と思いました。<br>
              確か「スター・ダスト」は原語で歌っていて、<strong>結構キザだった</strong>印象が・・(^_^;)。
            </p>

            <p>
              続いて本公演では、<strong>「猛き黄金の国」</strong>。場違いな討ち入り扮装で出てくるギャグ役は、当時雪組人気の脇役みやこちゃん(風早優)・・かと思っていたら、良く見たら違っていた！　・・すごく似ている子がいるね～、というのが、私たちの周りで話題になりました。<br>
              以来、<strong>こ(子)みやこちゃん</strong>と、・・先週まで呼んでおりました・・(^_^;)。<br>
              でも、もう、みやこちゃんが退団して随分経ちますものね～。今日からきぶなおちゃんと呼びますね、はい(^_^;)。
            </p>

            <p>
              みやこちゃんに似ていて、若手の頃から、そういうお笑い系、役者系の役が良くついていましたが、最初の頃は「エンカレ」での二枚目な選曲を見ていましたし、実際役に対してのアプローチも大人しめで、<strong>「どうなのかな～？　本当はこういう役を演りたい訳ではないのではないかな～？」</strong>と思いながら観ていました。<br>
              しかし、そのうち自覚が出たのか、楽しくなってきたのか、<strong>どんどん上手くなってきました</strong>ね。最近は、見る度に、自然に舞台で呼吸ができるようになっているのを感じます。<br>
              「エンカレ」で証明した通り、<strong>実はこっそり歌える</strong>(^_^;)のも強いですよね。「睡れる月」の<strong>宇迦斯</strong>も頼もしかったです。
            </p>

            <p>
              <strong>今や貴重な雪組芝居のムードメーカー</strong>だと思います。雪組にはやっぱり、こういう人が一人はいて欲しい！<br>
