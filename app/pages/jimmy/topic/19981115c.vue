<script setup>
definePageMeta({
  title: 'スターの小部屋／みきちゃん(真矢みき)スペシャル見ました',
  layout: 'jimmy',
  team: 'topics',
});
      ...
      <div class="flex-1 pl-2 md:pl-8 xl:pl-16 pr-2 md:pr-8 xl:pr-16 pb-16">
        <div class="pt-8">
          ...
          <div class="text-gray-800 text-base md:text-lg leading-8 [&>p]:mb-4">
            ...
            <p>いや～、らしい、といえばらしいけど(^_^;)、すごかったですね～、<strong>みきちゃん＆タモさん(愛華みれ)のトーク・・</strong>。個人的には、ファンにそこまで裏の状態を伝える必要はないと思うんだけど・・。でも、みきちゃんらしいし、<strong>ここまで素顔を伝えてくれるのが、ＷＯＷＯＷの醍醐味</strong>なんですよね、きっと(^_^;)。</p>
          </div>
        </div>
      </div>
