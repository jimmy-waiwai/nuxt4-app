      ...
      <div class="flex-1 pl-2 md:pl-8 xl:pl-16 pr-2 md:pr-8 xl:pr-16 pb-16">
        <div class="pt-8">
          ...
          <div class="text-gray-800 text-base md:text-lg leading-8 [&>p]:mb-4">
            ...
            <p><strong>本当ですか～？！もう、びっくりしました～</strong>(T_T)。</p>
            <p>あの、大劇場公演のみきちゃん見納めの日が、<strong>ほさっちゃんとのサヨナラの日</strong>となってしまうとは～。<strong>全然そんなつもりで見てなかったのに～</strong>！！まだまだ大女優になれる可能性のある人だっただけに、残念です。</p>
            <p>理由は・・、いろいろ憶測してしまいますが（^_^;）、余計なことは書かないでおきましょう。</p>
            <p><strong>どうなるんだ？これから？？</strong></p>
          </div>
        </div>
      </div>
