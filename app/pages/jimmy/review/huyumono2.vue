      ...
      <div class="flex-1 pl-2 md:pl-8 xl:pl-16 pr-2 md:pr-8 xl:pr-16 pb-16">
        <div class="pt-8">
          ...
          <div class="text-gray-800 text-base md:text-lg leading-8 [&>p]:mb-4">
            ...
            <p>
              <strong>今回の再演</strong>にははっきり言って疑問がありました。私の記憶に残っているバウでの同じ主演者の再演と言えば、<strong>杜けあきの「ヴァレンチノ」</strong>、昭和天皇崩御で途中休演となってしまった<strong>一路真輝の「ツーロンの薔薇」</strong>位。余程の事がない限り、再演はないはずなのに、<strong>何故この「冬物語」が再演されるのか？</strong>
            </p>
            <p>
            ...
            <p>
              <strong>児玉先生</strong>はこの作品を一体どう思われているんでしょうね。別に書き直さなくても十分な作品だと思われているのでしょうか。植田景子先生や荻田先生が再演の折りにガラッと作品を書き直して絶賛されているのですから(出演者が変わっているからではありますが)、新人ですし、<strong>春野寿美礼の為にも、別の新作を作り直すくらいの気概を見せて欲しかった</strong>です。
            </p>
            <p>
              <strong>春野、瀬奈じゅん</strong>は初演の時と比べて落ち着きが出ていて良かったです。<strong>春野</strong>は喉の調子が悪いようで、得意の歌が十分に聴かせられなかったのが残念でしたが、それでも十分上手い。初演では激情して変な行動に出ているように見えましたが(^_^;)、今回は狂気を静かに見せていて、恐ろしく感じられたのが面白かったです。<strong>瀬奈</strong>は難しい歌舞伎の場面に、大きさと迫力が出ていましたね。
            </p>
            <p>
              <strong>彩吹真央</strong>は相変わらずスカッとする出来映えで頼もしい。彦三郎が<strong>一樹千尋</strong>になって、ずっと良くなりました(すみません)。十郎太の<strong>桜一花</strong>も可愛らしい。
            </p>
            <p>
