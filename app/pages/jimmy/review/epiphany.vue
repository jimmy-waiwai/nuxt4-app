        ...
        <div class="flex-1 pl-2 md:pl-8 xl:pl-16 pr-2 md:pr-8 xl:pr-16 pb-16">
          <div class="pt-8">
            ...
            >
              ...
              <p>
                <strong>彩輝</strong
                >は出番の8割位は女役のおたかの方だったと思いますが、繊細な心の動きを丁寧に演じていて、色気と美貌も手伝って、彩輝ならではの役所で魅力を発揮していました。が、台詞や歌などキャリアの割にはあまりにも課題が多いのは気になります。これからの為にも、恵まれているだけに、必死で勉強して欲しいですね。
              </p>
              <p>
                <strong>妃里梨江</strong
                >も今回は文句なく衣装、鬘などに持ち前の美貌が生かせていて、とても美しかったです。「お嬢様」がピッタリでした。
              </p>
              <p>
                <strong>朝澄けい</strong
                >は今までのノーブルなイメージからするとかなり弾けた役だったのですが(^_^;)、伸び伸びとこなせていて上手かったです。新境地が開けたのではないでしょうか。
              </p>
              <p>
              ...
              <p>
                <strong>真飛聖</strong
                >がかなり背伸びした役所で、思い切り良く演じていたのが面白かったのですが、本当はシリアスだったのかどうか、大野先生の真意が気になる所です(^_^;)。何にしてもあれだけパンチがあるのは、大したスター性だと思いますが(^_^;)。
              </p>
              <p :class="textTitle">
