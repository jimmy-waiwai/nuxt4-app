      ...
      <div class="flex-1 pl-2 md:pl-8 xl:pl-16 pr-2 md:pr-8 xl:pr-16 pb-16">
        <div class="pt-8">
          ...
          <div class="text-gray-800 text-base md:text-lg leading-8 [&>p]:mb-4">
            ...
            <p>
              <strong>遠野</strong>は「Crossroad」の頃から比べると、<strong>随分すっきりとあか抜けて、キレイになったな</strong>、と思いました。最近TVや雑誌で見る素顔は、最近の女子高生みたい(言い方がおばさんクサいけど・・)ですが、舞台は随分大人っぽくて、ギャップに驚いてしまいます(^_^;)。スタイルが良くて、序盤のロングタイトスカートが良く似合っていて、ラブシーンで見える足も、すごくキレイでしたね(^_^;)。最後の赤のドレス、フィナーレの黒のドレスも大人っぽくてステキでした。<strong>歌も上手くて感心</strong>。花總まりに続く宙組若手娘役の中ではやはりピカ一かな、と思いました。
            </p>
            <p>
              <strong>夢輝</strong>のクラークは、「激情」のミカエラのイメージで見ると、<strong>ずっと激しくジョーシーを思っている人</strong>に作られていて、予想以上に熱い男でした(^_^;)。南部から出てきた、という設定で、衣装もカルメンにも言われている通りイマイチあか抜けないのですが、スラっとした立ち姿が良いです。静かな理の通った男のようで、母親が眠っている隣で、キレるまで激しく歌い、飛び起きた母親に「ちょっと机につまずいて・・」と言う所なんて、ちょっと裏表が激しすぎて恐い気も・・(^_^;)。<strong>あそこまで強い男なら、力ずくでもジョーシーを取り戻せそう</strong>な気はしました。
            </p>
            <p>
