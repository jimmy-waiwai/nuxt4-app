        ...
        <div class="flex-1 pl-2 md:pl-8 xl:pl-16 pr-2 md:pr-8 xl:pr-16 pb-16">
          <div class="pt-8">
            ...
            >
              ...
              <p>
                シアター・ドラマシティで<strong>「Dawn」</strong>観てきました。
              </p>
              <p>
                まず、<strong>ずんちゃん(姿月あさと)でどんな舞台を作るか</strong>、から始まった作品ですね。プログラムでも書かれていますが。<br />
                <strong>ピュアな笑顔の少年</strong
                >を通して、現代社会の中で見失いそうになる大切なものが上手く伝えられていて、共感できました。<br />
                <strong>力強いモダンダンスで訴える演出</strong
                >は、いかにも<strong>謝先生</strong>。<strong>台詞は哲学的で考えさせられるものが多く</strong>、いかにも<strong>荻田先生</strong>。それが良いです。
              </p>
              <p>
                <strong>長尾まや(蘭香レア)</strong
                >ちゃん、スタイルが良くて抜群にキレイ。ダンスも文句なしでした。少し台詞も聞けましたが、自然で良かったですよ。これから十分に活躍できるのではないでしょうか。
              </p>
              <p>
              ...
              <p>
                彼女は今回、舞台に立っていますが、<strong
                  >舞台がやりたいのでしょうか？</strong
                ><br />
