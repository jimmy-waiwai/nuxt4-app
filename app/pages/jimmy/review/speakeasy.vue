      ...
      <div class="flex-1 pl-2 md:pl-8 xl:pl-16 pr-2 md:pr-8 xl:pr-16 pb-16">
        <div class="pt-8">
          ...
          <div class="text-gray-800 text-base md:text-lg leading-8 [&>p]:mb-4">
            ...
            <p>ミキちゃんらしい舞台ですね(^_^;)。<strong>面白かった</strong>です。</p>
            <p>
              雪組ファンとしては、「春櫻賦」で<strong>谷正純先生</strong>に対して怒りまくっていたので(^_^;)、<strong>ちゃんとした話も作れるんだ(失礼な)と、ちょっと見直しました</strong>。原作があるからかな？
            </p>
            <p>
              <strong>ゴルチェの衣装</strong>はさすがに豪華です。でも、男役のスーツって、長年の舞台で研究され尽くした(^_^;)、あの独特の形のものが、一番美しく見えると思うんです。まあ、前のＫＥＮＺＯよりはましだと思いますが(^_^;)。
            </p>
            <p><strong>「スナイパー」</strong></p>
            <p>石田昌也先生のショー、結構好きだったんですが、どうしちゃったんでしょう？</p>
            <p>これは、ミキちゃんファンが怒っても仕方がないと思いますね。</p>
            <p>
              まず、<strong>ミキちゃんのかっこ良い場面が少ない</strong>！
              <strong>これはサヨナラ公演なんですから致命的</strong>ですね。普通の二枚目が、「アウシュビッツ」と最後の大階段のソロ(これは良かった！)だけとは寂しすぎます。
            </p>
            <p>「ハリマオ」はきっと東京では別の場面に変わると予想します(^_^;)。</p>
            <p>
            ...
            <p>
              <strong>ほさちちゃん(千ほさち)</strong>も相変わらずハジケてます(^_^;)。キレイです。パパラッチの場面の銀橋ソロで、ヒゲを付けるのはやめた方が良いと思うなぁ。せっかくの銀橋ソロなのに、勿体無いです。かっこ良く歌って、「本当は女の子なんだもーん」とやるだけでも、十分に面白いと思うのですが。
            </p>
            <p>
              <strong>タモさん(愛華みれ)</strong>はようやく頼もしくなってきましたね。パパラッチが多少バドっぽいケド(^_^;)、鮮やかな衣装が似合っていてキレイ。<strong>チャーリー(匠ひびき)</strong>もポジションが上がって、活躍していました。仕立て屋さんが可愛かった(^_^;)。<strong>伊織直加</strong>が、今回は芝居の方もなかなかの二枚目で目立ちました。
            </p>
            <p>
              <strong>詩乃優花</strong>も良い役で、ミキちゃんとの歴史も長いだけに、感慨一入でした。気持ちよい芝居＆ダンス、大好きだったので、寂しいです。
            </p>
            <p>
              <strong>渚あき</strong>も良いですね。「産まれるー」がカワイイ(^_^;)。ショーでのパーサー姿もイケてます。「若い子には負けない」なんて歌詞、まだまだ言って欲しくないです(^_^;)。
            </p>
            <p>
