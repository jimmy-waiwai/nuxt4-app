      ...
      <div class="flex-1 pl-2 md:pl-8 xl:pl-16 pr-2 md:pr-8 xl:pr-16 pb-16">
        <div class="pt-8">
          ...
          <div class="text-gray-800 text-base md:text-lg leading-8 [&>p]:mb-4">
            ...
            <p>
              <strong>「ザ・レビュー'99」</strong>は、「ノバ・ボサ・ノバ」に引き続き、二組で上演される今年の目玉のショーですが、残念ながらそれほどの名作とは言えないものでした。まず、メインと思われる<strong>「夢人」</strong>が、初演当時は絶賛されたものだったのかもしれませんが、今の私が見る限り、面白くない上に長過ぎます。もっと他に良い場面はなかったのでしょうか。それに<strong>全体に衣装が悪い！</strong>&emsp;これが、相当足を引っ張っているような気がしました。
            </p>
            <p>
            ...
            <p>
              <strong>アトランティック・オーシャン</strong>では黒エンビの端正さがさすが。花總との大人っぽいデュエットもムード満点でした。<strong>夢人</strong>は、冒頭の少年姿が一番！&emsp;姿月ならではの可愛らしさです。<strong>フィナーレ</strong>のデュエットもみずみずしい。
            </p>
            <p>
              <strong>カルメンの花總まり</strong>。本当に素晴らしい娘役ですね！&emsp;宙組になって以降、「エクスカリバー」のロザライン、エリザベートと、十分の出来ながら、少し落ち着きすぎの感があったのと、痩せすぎて美貌が落ちているのではないかとの心配がありましたが、今回のカルメンは<strong>ずっと見続けている私でも目の覚めるような美しさ！</strong>&emsp;登場の際のインパクトの強さ、連行の際の誘惑の迫力、自然と客席からも拍手の起こったフラメンコのソロ、<strong>どれも今の花總でしか考えられない様な、突出した頼もしさ</strong>を感じます。
            </p>
            <p>
            ...
            <p>
              <strong>和央ようか</strong>もだんだんと頼もしさが増してきましたね。<strong>メリメ</strong>の方は理性的で、ホセとの対比が出ていましたし、<strong>ガルシア</strong>でのホセとの対決シーンは、長身の二人だけに迫力ありました。ショーでも、今回は<strong>落ち着いた雰囲気</strong>を全面に出していて、大人っぽくなったな、と思いました。<strong>間奏曲のジゴロの場面</strong>が、かっこ良かったですね。
            </p>
            <p>
              <strong>湖月わたるはエスカミリオ</strong>。人気のマタドールという文句なくかっこ良い役で、<strong>登場の時の爽やかさ</strong>は湖月ならでは。非常にキザに、かっこつけているのですが、その辺りがいまいちサマになっていないのが物足りない。もっと色気が欲しいですね。ショーでも、<strong>ロケット</strong>、アトランティック・オーシャンの<strong>銀橋で歌う男</strong>の、覇気ある爽やかさが良いです。
            </p>
            <p>
