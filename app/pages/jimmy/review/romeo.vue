      ...
      <div class="flex-1 pl-2 md:pl-8 xl:pl-16 pr-2 md:pr-8 xl:pr-16 pb-16">
        <div class="pt-8">
          ...
          <div class="text-gray-800 text-base md:text-lg leading-8 [&>p]:mb-4">
            ...
            <p>
              <strong>「～'99」</strong>と名付ける事によって大きく変わったのはビジュアル。時代背景にとらわれない衣装、装置、照明、どれをとっても先生のこだわりが感じられ、繊細でとても美しい。特にセットと照明の色合いが気に入りました。
            </p>
            <p>
            ...
            <p>
              <strong>眉月凰</strong>が、パリス伯爵を美しく見せてくれて、久しぶりの歌も頼もしい。マーキューシオの<strong>彩吹真央</strong>も衣装、髪型が良く似合い、台詞の明瞭さでは一番。
            </p>
            <p>
